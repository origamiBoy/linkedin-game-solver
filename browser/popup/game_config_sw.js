...
const GAME_CONFIG = {
    ...
    queens: {
        ...
        urlPattern: "queens", // Add this field
        icon: {
    ...
    tango: {
        ...
        urlPattern: "tango", // Add this field
        icon: {
    ...
    pinpoint: {
        ...
        urlPattern: "pinpoint", // Add this field
        icon: {
    ...
    crossclimb: {
        ...
        urlPattern: "crossclimb", // Add this field
        icon: {
